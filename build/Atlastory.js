    ...
    $tl.html('<div class="box">' +
        '<div class="container">' +
            ...
            '<div class="signifiers">' +
                '<div class="arrow left"><span>&laquo;</span></div>' +
                '<div class="arrow right"><span>&raquo;</span></div>' +
            '</div>' +
        '</div>' +
        '<div class="slider">' +
            '<div class="top"></div>' +
...
fn.renderMap = function() {
    ...
    // If there's a period, show it
        if (Atlastory._options.preload) period.mapLayer.bringToFront();
    ...
    // If there aren't any periods, show only blank map
        ...
        if (Atlastory._options.preload) blank.bringToFront();
